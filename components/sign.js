...
export default function Sign() {
    ...
    const [helpText, setHelpText] = useState("6-12자 이내 영문, 숫자만 사용가능");
    ...
    const handleIdChange = (event) => {
        ...
        if( regexId.test(value)) {
            ...
            setHelpText("사용가능한 ID입니다.")
            setIdError(false)
            setShowPwField(true);
        } else {
            console.log("유효하지 않습니다.")
            setHelpText("유효하지 않은 아이디입니다. 6-12자 이내 영문, 숫자만 사용가능")
            setIdError(true)
